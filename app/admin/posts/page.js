                ...
                <div className="grid gap-4 grid-cols-3 w-full p-6 ">
                    {posts.map((post, index) => (
                        <div key={index} className="flex w-full items-center justify-center shadow-md hover:shadow-xl rounded-lg border hover:cursor-pointer text-center px-6">
                            <Link href={`/admin/posts/view/${post.id}`} className='flex flex-grow items-center justify-center'>
                            ...
                            <Link href={`/admin/posts/edit/${post.id}`} className='flex flex-shrink'>
                            ...
                            <Link href={`/admin/posts/delete/${post.id}`} className='flex flex-shrink'>
                                <div class="flex flex-col p-2">
